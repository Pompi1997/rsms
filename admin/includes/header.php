<nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="dashboard.php">
            <strong style="color: white;font-size: 30px">RSMS</strong>
        </a>
    </div>
    <!-- end navbar-header -->
    <!-- navbar-top-links -->
    <ul class="nav navbar-top-links navbar-right">
        <!-- main dropdown -->
        <?php
        $sql = "SELECT * from queries where IsRead is null limit 50";
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <span class="top-label label label-danger"><?php echo $newmsg; ?></span><i class="fa fa-envelope fa-2x"></i>
            </a>
            <!-- dropdown-messages -->
        ...
        <?php
        $sql = "SELECT * from customer_bookings where Status is null limit 50";
        $query = $dbh->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <span class="top-label label label-warning"><?php echo $newbooking; ?></span> <i  class="fa fa-bell fa-2x "></i>
            </a>
            <!-- dropdown alerts-->
            <ul class="dropdown-menu dropdown-alerts">
                ...
                if ($query->rowCount() > 0) {
                    foreach ($results as $row) {  ?>
                        <li>
                            <a href="view-booking-requests.php?viewid=<?php echo htmlentities($row->ID); ?>">
                                <div>
