...
if (strlen($_SESSION['rsmsid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $mobnum = $_POST['mobnum'];
    $email = $_POST['email'];
    $sql = "update pages set PageTitle=:pagetitle,PageDescription=:pagedes,Email=:email,MobileNumber=:mobnum where  PageType='contactus'";
...
?>
  ...
  <head>
    ...
    <title>Relocation and shifting Management System | Contact Us</title>
