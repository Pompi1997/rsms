...
<head>
    ...
    <title>Relocation and shifting Management System | Forgot Password Page</title>
        ...
        <div class="container">
            <div class="button-85 "><br>
                <h2 style="color:#fff;text-transform: uppercase;">
                    <center>Relocation and shifting Management System
                </h2>
                <BR><br>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 text-center logo-margin ">
                <strong style="color: white;font-size: 50px">RSMS ADMIN</strong>
            </div>
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" name="chngpwd" onSubmit="return valid();">
                            <fieldset>
                                ...
                                <center><button type="submit" class="button-85" name="submit">Submit</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
