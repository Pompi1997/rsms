        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <!-- page header -->
                    <div class="col-lg-12">
                        <h1 class="page-header">View Cancelled Bookings</h1>
                    </div>
                    <!--end page header -->
                </div>
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "SELECT * from customer_bookings where Status = 0 ";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form method="post" action="send_script.php">
                                                                    <input type="text" name="body" placeholder="cite reason of cancellation" />
