        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 text-center logo-margin ">
                    <strong style="color: #fff;font-size: 50px">RSMS ADMIN</strong>
                </div>
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel ">
                        <div class="panel-heading">
                            <h3 class="panel-title"><center>Please Sign In</h3><hr style="color:blueviolet">
                        </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <label style="float:right;">
                                            <a href="forgot-password.php"><b>Forgot Password?</b></a></label>
                                    </div>
