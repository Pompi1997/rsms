...
?>
    ...
    <head>
        ...
        <title>Relocation and shifting Management System | Booking Reports</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <!-- page header -->
                    <div class="col-lg-12">
                        <h1 class="page-header">Booking Between Dates </h1>
                    </div>
                    <!--end page header -->
                </div>
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form method="post" name="bwdatesreport" action="booking-bwdates-reports-details.php">
                                            ...
                                            <p style="padding-left: 450px"><button type="submit" class="button-85" name="submit" id="submit">Submit</button></p>
                                        </form>
                                    </div>
